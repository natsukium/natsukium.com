import { DocumentIcon, MetadataItem, ProfileSection, TagIcon, UserIcon } from "./components";
import loadGoogleFonts, { type FontOptions } from "../loadGoogleFont";
import { SITE } from "@config";
import type { SiteOgOptions } from "../generateOgImages";
import satori from "satori";

const SiteOgImage = async ({ postCount, topTags }: SiteOgOptions) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          {topTags.length > 0 && <MetadataItem icon={<TagIcon />} text={tagsText} />}
        </div>
      </div>
